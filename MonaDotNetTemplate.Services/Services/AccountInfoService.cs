...
{
    public class AccountInfoService : BaseService<AccountInfo, BaseGetPaginationRequest>, IAccountInfoService
    {
        public AccountInfoService(IUnitOfWork unitOfWork, IAppDbContext context) : base(unitOfWork, context)
        {
        }
    }
}
