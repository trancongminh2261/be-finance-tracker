...
{
    public class RoleService : BaseService<Role, BaseGetPaginationRequest>, IRoleService
    {
        public RoleService(IUnitOfWork unitOfWork, IAppDbContext context) : base(unitOfWork, context)
        {
        }
    }
}
