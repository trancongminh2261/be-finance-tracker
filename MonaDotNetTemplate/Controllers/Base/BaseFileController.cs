...
namespace MonaDotNetTemplate.API.Controller.Base
{
    [ApiController]
        ...
        {            
            ...
            await Task.Run(async () =>
            {
                if (file != null && file.Length <= 2097152)
                {
                    ...
                    var currentLinkSite = $"https://{MonaDotNetTemplate.Extensions.HttpContext.Current.Request.Host}/{"Uploads"}/{upLoadFolder}";
