...
namespace MonaDotNetTemplate.API.Controllers
{
    ...
    [ApiController]
    public class RoleController : BaseController<Role, RoleModel, BaseGetPaginationRequest, RolePostRequest, RolePutRequest>
    {
        public RoleController(IServiceProvider serviceProvider, ILogger<ControllerBase> logger, IWebHostEnvironment env) : base(serviceProvider, logger, env)
        {
            this.baseService = serviceProvider.GetRequiredService<IRoleService>();
            this.baseService.GetSQLFilePath = "SQL/RoleGetPaging.sql";
        }
    }
}
